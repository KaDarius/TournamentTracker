...
namespace TrackerLibrary
{
    ...
    {   
       ...
       /// </summary>
        ...
        /// <summary>
        /// overloaded constructor, to create a prize model on the fly
        /// and populate and do all the parsing once. And anywhere that calls PrizeModel can get that instance
        /// </summary>
        public PrizeModel(string placeName, string placeNumber, string prizeAmount, string prizePercentage)
        {
            ...
            float prizePercentageValue = 0;
            float.TryParse(prizePercentage, out prizePercentageValue);
